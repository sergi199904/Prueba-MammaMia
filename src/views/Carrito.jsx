...
export default function Carrito() {
  ...
  const totalPrice = () => {
    const coolReducer = (coolAccumulator, coolCurrentValue) =>
      coolAccumulator + coolCurrentValue.price;
    const coolSum = galeria
      .filter((pizza) => pizza.state === true)
      .reduce(coolReducer, 0);
    return coolSum;
  };
